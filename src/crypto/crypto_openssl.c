...
struct crypto_ec * crypto_ec_subgroup(struct crypto_ec_point **out_generator)
{
	...
	unsigned char a_bin[] = {0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc};
	unsigned char b_bin[] = {0xfe, 0x52, 0x40, 0xb6, 0xee, 0x72, 0x73, 0xd1, 0x43, 0x09, 0xcc, 0x22, 0xf0, 0x66, 0x4a, 0xd4, 0x5a, 0xd7, 0x6d, 0x4b, 0x13, 0x89, 0x95, 0x2c, 0x3f, 0xd9, 0xf8, 0x54, 0xd5, 0x5b, 0xfa, 0x80};
	unsigned char p_bin[] = {0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
	unsigned char order_bin[] = {0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0x0b, 0x2e, 0x09, 0x5b, 0x89, 0x8d, 0xf5, 0xb3, 0xf5, 0x9b, 0x25, 0xb0, 0x68, 0xb3, 0xa4, 0x7d};
	unsigned char x_bin[] = {0x6b, 0xfe, 0x1a, 0x57, 0x02, 0x46, 0x8a, 0xc7, 0xe2, 0xe7, 0xef, 0xd2, 0x2a, 0x25, 0xcc, 0xf5, 0x1a, 0xda, 0xbf, 0x60, 0xd3, 0x85, 0x17, 0x33, 0x2f, 0x07, 0xd2, 0x2f, 0x9a, 0x88, 0x75, 0x55};
	unsigned char y_bin[] = {0x75, 0x82, 0xb0, 0x15, 0x15, 0x68, 0x89, 0xef, 0x88, 0xe5, 0x03, 0x05, 0x4b, 0xd9, 0x71, 0x75, 0xdf, 0xb6, 0x19, 0x7c, 0x94, 0x32, 0xa4, 0xfc, 0x6c, 0xfb, 0x07, 0x5e, 0xcb, 0x2d, 0xb9, 0x2d};

	/* Set the values for the various parameters */
	e->a = BN_bin2bn(a_bin, sizeof(a_bin), NULL);
	e->b = BN_bin2bn(b_bin, sizeof(b_bin), NULL);
	e->prime = BN_bin2bn(p_bin, sizeof(p_bin), NULL);
	e->order = BN_bin2bn(order_bin, sizeof(order_bin), NULL);
	e->bnctx = BN_CTX_new();
	x = BN_bin2bn(x_bin, sizeof(x_bin), NULL);
	y = BN_bin2bn(y_bin, sizeof(y_bin), NULL);
